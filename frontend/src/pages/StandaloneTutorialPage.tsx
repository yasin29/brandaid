...
export default function StandaloneTutorialPage() {
  return (
      ...
      <nav className="sticky top-0 z-50 border-b border-white/5 bg-[#050508]/90 backdrop-blur-xl">
        <div className="max-w-5xl mx-auto px-8 h-14 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-slate-400 text-xs">Tutorial</span>
          </div>
          <div className="flex items-center gap-4">
            <Link to="/docs" className="text-xs text-slate-500 hover:text-slate-300 transition-colors">
              Docs
            </Link>
